...
```sh
wget https://github.com/hadfl/kvmadm/releases/download/v0.9.0-rc2/kvmadm-0.9.0-rc2.tar.gz
tar zxvf kvmadm-0.9.0-rc2.tar.gz
cd kvmadm-0.9.0-rc2
./configure --prefix=/opt/kvmadm-0.9.0-rc2 
```
